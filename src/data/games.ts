...
const THUMB = {
  action:     { bg: '8b0000', fg: 'ff6b6b' },
  puzzle:     { bg: '1a1a2e', fg: '8b5cf6' },
  racing:     { bg: '0a3d0a', fg: '4ade80' },
  sports:     { bg: '0a2a4d', fg: '38bdf8' },
  shooting:   { bg: '4a1a00', fg: 'f97316' },
  adventure:  { bg: '1a3a1a', fg: '22d3ee' },
  strategy:   { bg: '2a1a3a', fg: 'c084fc' },
  arcade:     { bg: '3a1a2a', fg: 'f472b6' },
  multiplayer:{ bg: '1a2a3a', fg: 'fbbf24' },
  'io-games': { bg: '0a2a2a', fg: '2dd4bf' },
};

function thumb(category: string, text: string): string {
  const c = THUMB[category as keyof typeof THUMB] ?? { bg: '1a1a2e', fg: '8b5cf6' };
  return `https://placehold.co/400x300/${c.bg}/${c.fg}?text=${encodeURIComponent(text)}`;
}
...
export const games: Game[] = [
  // ─── Puzzle ───────────────────────────────────────────────────────────────
  {
    ...
    category: 'puzzle',
    thumbnailUrl: thumb('puzzle', '2048'),
  ...
  },
  {
    ...
    category: 'puzzle',
    thumbnailUrl: thumb('puzzle', 'Tetris'),
  ...
  },
  {
    ...
    category: 'puzzle',
    thumbnailUrl: thumb('puzzle', 'Minesweeper'),
  ...
  },
  {
    ...
    category: 'puzzle',
    thumbnailUrl: thumb('puzzle', 'Memory+Match'),
  ...
  },
  {
    ...
    category: 'puzzle',
    thumbnailUrl: thumb('puzzle', 'Hextris'),
  ...
  // ─── Arcade ───────────────────────────────────────────────────────────────
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Snake'),
  ...
  },
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Breakout'),
  ...
  },
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Tower+Stack'),
  ...
  },
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Pac-Man'),
  ...
  },
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Floppy+Bird'),
  ...
  },
  {
    ...
    category: 'arcade',
    thumbnailUrl: thumb('arcade', 'Clumsy+Bird'),
  ...
  // ─── Shooting ─────────────────────────────────────────────────────────────
  {
    ...
    category: 'shooting',
    thumbnailUrl: thumb('shooting', 'Space+Invaders'),
  ...
  },
  {
    ...
    category: 'shooting',
    thumbnailUrl: thumb('shooting', 'Radius+Raid'),
  ...
  // ─── Adventure ────────────────────────────────────────────────────────────
  {
    ...
    category: 'adventure',
    thumbnailUrl: thumb('adventure', 'Astray+Maze'),
  ...
  // ─── Strategy ─────────────────────────────────────────────────────────────
  {
    ...
    category: 'strategy',
    thumbnailUrl: thumb('strategy', 'Tic+Tac+Toe'),
  ...
  // ─── Action (NEW) ─────────────────────────────────────────────────────────
  {
    ...
    category: 'action',
    thumbnailUrl: thumb('action', 'Ninja+Slash'),
  ...
  },
  {
    ...
    category: 'action',
    thumbnailUrl: thumb('action', 'Zombie+Survivor'),
  ...
  // ─── Racing (NEW) ─────────────────────────────────────────────────────────
  {
    ...
    category: 'racing',
    thumbnailUrl: thumb('racing', 'Speed+Racer'),
  ...
  },
  {
    ...
    category: 'racing',
    thumbnailUrl: thumb('racing', 'Drift+King'),
  ...
  // ─── Sports (NEW) ─────────────────────────────────────────────────────────
  {
    ...
    category: 'sports',
    thumbnailUrl: thumb('sports', 'Ping+Pong'),
  ...
  },
  {
    ...
    category: 'sports',
    thumbnailUrl: thumb('sports', 'Basketball'),
  ...
  // ─── Multiplayer (NEW) ────────────────────────────────────────────────────
  {
    ...
    thumbnailUrl: thumb('multiplayer', 'Tank+Battle'),
  ...
  // ─── IO Games (NEW) ───────────────────────────────────────────────────────
  {
    ...
    category: 'io-games',
    thumbnailUrl: thumb('io-games', 'Dot+Eater'),
  ...
  },
  {
    ...
    category: 'io-games',
    thumbnailUrl: thumb('io-games', 'Slither+Solo'),
